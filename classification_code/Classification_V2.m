function [dtpredict,OA_SVM1, OA_SVM2, AA_SVM1, AA_SVM2, ave_Kappa_SVM1, ave_Kappa_SVM2,ave_TPR_SVM1,ave_TPR_SVM2] = Classification_V2(org_data,re_data,GT_map,iter,CTrain)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for i=1:iter
    ...
    %% SVM
    [accur11, Kappa11,TPR11,class,class2] = Excute_SVM(Data_R1, loc_train, CTrain, loc_test, CTest);
